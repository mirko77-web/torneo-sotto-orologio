...
const regole = [
  'OGNI SQUADRA PUÒ ISCRIVERE UN NUMERO MASSIMO DI 8 GIOCATORI',
  'NUMERO MINIMO IN CAMPO DI GIOCATORI PER POTER INIZIARE LA PARTITA È DI 4 COMPONENTI',
  'È CONSIGLIATA LA FIGURA DI UN ALLENATORE PER SQUADRA',
  'DURANTE LO SVOLGIMENTO DELLE GARE SOLO ALLENATORE E/O PRESIDENTE POSSONO ACCEDERE ALL’AREA TECNICA (PANCHINA)',
  'È PREVISTO UN TEMPO MASSIMO DI TOLLERANZA DI 6 MINUTI DALL’ORARIO DI INIZIO PROGRAMMATO',
  'IL SUPERAMENTO DEL TEMPO DI TOLLERANZA SENZA CHE LA SQUADRA SI SIA PRESENTATA IN CAMPO CON IL NUMERO MINIMO DI GIOCATORI COMPORTERÀ AUTOMATICAMENTE LA SCONFITTA A TAVOLINO',
  'LE PARTITE AVRANNO UNA DURATA DIFFERENZIATA IN BASE ALLA FASE DEL TORNEO,FASE A GIRONI 1 TEMPO DI 12 MINUTI,FASE FINALE 2 TEMPI DA 10 MINUTI,FINALISSIMA 2 TEMPI DA 15 MINUTI',
  'LA LISTA UFFICIALE DEI GIOCATORI DEVE ESSERE DEPOSITATA ENTRO IL 5 LUGLIO. CONTESTUALMENTE ALLA CONSEGNA DELLA LISTA, DOVRÀ ESSERE EFFETTUATO IL SALDO  (euro 120) DELLA QUOTA DI ISCRIZIONE',
  'PREMI IN DENARO E COPPE PER SQUADRE VINCITRICI E SINGOLI TALENTI (MIGLIOR PORTIERE, MIGLIOR GIOCATORE, CAPOCANNONIERE, MIGLIOR ALLENATORE)',
];
